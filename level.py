...
class Level:
    ...
    def override_vars(self):
        ...
        self.boss_quantities = None
        self.weapon = None
        self.boss_min_cols = 0/5
        self.boss_max_cols = 5/5
        self.boss_min_rows = 0/5
    ...
    def new_game(self):
        ...
        add_sprite(AnimatedSprite(self, pos=(1.5, 1.5)))
        add_sprite(AnimatedSprite(self, pos=(1.5, 7.5)))
        add_sprite(AnimatedSprite(self, pos=(5.5, 3.25)))
        add_sprite(AnimatedSprite(self, pos=(5.5, 4.75)))
        add_sprite(AnimatedSprite(self, pos=(7.5, 2.5)))
        add_sprite(AnimatedSprite(self, pos=(7.5, 5.5)))
        add_sprite(AnimatedSprite(self, pos=(14.5, 1.5)))
        add_sprite(AnimatedSprite(self, pos=(14.5, 4.5)))
        ...
        add_sprite(AnimatedSprite(self, pos=(14.5, 24.5)))
        add_sprite(AnimatedSprite(self, pos=(14.5, 30.5)))
        add_sprite(AnimatedSprite(self, pos=(1.5, 30.5)))
        add_sprite(AnimatedSprite(self, pos=(1.5, 24.5)))
